 ...
 */
public class UnlimitedTerritoryCardsTest {

    private Player mPlayer = new Player("Ale", "Green",1, 1 );
    ...
    public void setUp() throws Exception {
        ...
        mScanner = new Scanner(new File(mFilePath + "15.json"));
        ...
        mFaithPoints = new FaithPoints(4);
        mCoins = new Coins(12);
    ...
    public void doActionTest() throws Exception {
        ...
        assertEquals(true, mPlayer.getBonusFlags().getBonus("UnlimitedTerritoryCards"));
