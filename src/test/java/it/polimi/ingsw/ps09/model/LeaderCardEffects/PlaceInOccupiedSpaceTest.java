 ...
 */
public class PlaceInOccupiedSpaceTest {
    ...
    public void setUp() throws Exception {
        ...
        mScanner = new Scanner(new File(mFilePath + "2.json"));
    ...
    public void doActionTest() throws Exception {
        ...
        assertEquals(true, mPlayer.getBonusFlags().getBonus("PlaceFamilyMemberInOccupiedActionsSpaces"));
