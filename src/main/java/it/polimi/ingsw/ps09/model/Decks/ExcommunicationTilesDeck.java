...
public class ExcommunicationTilesDeck {
    ...
    private List<ExcommunicationTile> mExcommunicationTilesTierOne = new ArrayList<>();
    private List<ExcommunicationTile> mExcommunicationTilesTierTwo = new ArrayList<>();
    private List<ExcommunicationTile> mExcommunicationTilesTierThree = new ArrayList<>();
